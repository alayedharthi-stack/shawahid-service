...
- "الأهداف / نواتج التعلم / بنهاية الدرس يستطيع / تحضير / الأسبوع الأول" → التخطيط
- "توزيع منهج / الفصل الدراسي / المقرر / الوحدة الأولى / جدول الحصص" → التخطيط
- "الدرجة الكلية / توزيع الدرجات / اختر / أجب / ورقة عمل / واجب" → التقويم
- "اختبار نهائي / مهمة أدائية / أسئلة الاختبار / الفصل الثاني" → التقويم
